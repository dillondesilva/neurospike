  ...
  return (
    <div>
        <div className="flex flex-col justify-center w-screen h-screen">
            ...
            <h1 className="text-5xl self-center text-center" >Welcome to <h1 className="font-bold">Neurospike</h1></h1>
            ...
            <p className="mt-6 text-center w-full self-center">Try it out now<p className="font-bold">on desktop! Please use fullscreen for the optimal experience</p></p>
            {/* <img src='logo-white-bg.png' className="place-items-center  w-[35vw] h-[35vw]" alt="logo"/> */}
        </div>
    </div>
  );
