...
export default function HHControlPanel() {
...
const naConductanceSlider = useRef();
const kConductanceSlider = useRef();
const leakConductanceSlider = useRef();
